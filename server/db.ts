...
// Use Replit's database URL or fallback to a default for development
const databaseUrl = process.env.DATABASE_URL || process.env.REPLIT_DB_URL || 'postgresql://neondb_owner:password@localhost:5432/neondb';
