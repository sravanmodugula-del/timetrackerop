...
-- =============================================================================
-- Drop existing tables (cascade order matters)
-- =============================================================================
...
-- Employees (simplified - links to users)
...
-- Time Entries (main functionality)
...
-- =============================================================================
-- Update Triggers (simplified)
-- =============================================================================

-- Generic update trigger template
CREATE OR ALTER TRIGGER TR_users_update ON users AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER TRIGGER TR_organizations_update ON organizations AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER TRIGGER TR_employees_update ON employees AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER TRIGGER TR_projects_update ON projects AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER TRIGGER TR_tasks_update ON tasks AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE OR ALTER TRIGGER TR_timeentries_update ON time_entries AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
